...
export async function topologicalSort(vertices, edges, updateEdges, updateVertices, speed) {
...
export async function topologicalSortKahn(vertices, edges, updateEdges, updateVertices, speed) {
